...
spl_autoload_register(function ($class) {
    $classMap = [
        ...
        'Saeghe\Saeghe\FileManager\DirectoryAddress' => Address::from_string(__DIR__ . '/Source/FileManager/DirectoryAddress.php')->to_string(),
        'Saeghe\Saeghe\FileManager\FileAddress' => Address::from_string(__DIR__ . '/Source/FileManager/FileAddress.php')->to_string(),
        'Saeghe\Saeghe\FileManager\SymlinkAddress' => Address::from_string(__DIR__ . '/Source/FileManager/SymlinkAddress.php')->to_string(),
