...
function assert_source_has_been_built($message)
{
    ...
    assert(
        file_exists($environmentBuildPath . '/Source/ImportableSample.php')
        && file_exists($environmentBuildPath . '/Source/ImportableSampleClass.php')
        ...
        && file_exists($environmentBuildPath . '/Source/SubDirectory/ClassUseNamespaceTwice.php')
        ...
        && file_get_contents($environmentBuildPath . '/Source/ImportableSample.php') === str_replace('$environmentBuildPath', $environmentBuildPath, file_get_contents($stubsDirectory . '/Source/ImportableSample.stub'))
        && file_get_contents($environmentBuildPath . '/Source/ImportableSampleClass.php') === str_replace('$environmentBuildPath', $environmentBuildPath, file_get_contents($stubsDirectory . '/Source/ImportableSampleClass.stub'))
        ...
        && file_get_contents($environmentBuildPath . '/Source/SubDirectory/ClassUseNamespaceTwice.php') === str_replace('$environmentBuildPath', $environmentBuildPath, file_get_contents($stubsDirectory . '/Source/SubDirectory/ClassUseNamespaceTwice.stub'))
